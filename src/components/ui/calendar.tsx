  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected].day-range-end)]:rounded-r-md border",
          props.mode === "range"
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 hover:rounded-none"
        ),
